...
- [x] **AI-210** — Block deletion of referenced AssetRecords.
...
- [x] **AI-224** — Constrain custom curve x/y handles to 0..1.
- [x] **AI-225** — Make one handle drag one undoable transaction with Esc cancel.
